package springservice.common.security.config;
...
import springservice.common.CustomCorsFilter;
import springservice.common.security.RestAuthenticationEntryPoint;
import springservice.common.security.auth.ajax.AjaxAuthenticationProvider;
import springservice.common.security.auth.ajax.AjaxLoginProcessingFilter;
import springservice.common.security.auth.jwt.JwtAuthenticationProvider;
import springservice.common.security.auth.jwt.JwtTokenAuthenticationProcessingFilter;
import springservice.common.security.auth.jwt.SkipPathRequestMatcher;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		List<String> permitAllEndpointList = Arrays.asList(AUTHENTICATION_URL, REFRESH_TOKEN_URL, "/h2-console/**",
				SIGN_UP_URL);
